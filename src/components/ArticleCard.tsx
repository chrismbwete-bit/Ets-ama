  ...
  return (
    <div className="card-dark rounded-2xl overflow-hidden group">
      ...
      <div className="p-4 space-y-3">
        <h3 className="font-bold text-white text-lg leading-tight line-clamp-2">{article.name}</h3>
        ...
        <div className="pt-2 border-t border-purple-500/10">
          <div className="flex items-center justify-between">
            <div>
              <p className="font-bold text-purple-400 text-lg text-glow-purple">{article.priceFC.toLocaleString()} {settings.currencyFC}</p>
              <p className="text-cyan-400/70 text-sm">{article.priceUSD.toLocaleString()} {settings.currencyUSD}</p>
            </div>
          </div>
        </div>
